...
namespace OnTheSpot.Dal
{
    public class DBAccess
    {
        ...
        public DBAccess(int storeid)
        {
            ...
            string storeconnectionstring = connectionNames[storeid];
            //retrieve the connection string from app.config
            ConnectionStringSettingsCollection connections = ConfigurationManager.ConnectionStrings;

            Store1Entities db = new Store1Entities(connections[storeconnectionstring].ConnectionString);
        ...
        {
            DAL.EFStuff.Stores.Employee emp = null;
 ...
 //                    Category = item.Category,
         ...
         public void SaveGssItem(OnTheSpot.Models.GSS gss)
         {
            ...
            DAL.EFStuff.BCS.GSS dbItem = new DAL.EFStuff.BCS.GSS() { barcode = gss.BarCode, bin = gss.bin, time = gss.CreationDate,temp3 = "temp"};
             db.GSSes.Add(dbItem);
             db.SaveChanges();
         }
         public string SaveQCS(string heatseal,string location)
         {
            ...
            DAL.EFStuff.BCS.QCSInfo dbItem = new DAL.EFStuff.BCS.QCSInfo() {  HeatSeal=heatseal, Bin=location, Time = DateTime.Now };
         ...
         public OnTheSpot.Models.Customer GetCustomerInfo(int WorkOrderNumber)
        {
         ...
         {
             return (from cust in dbStore.Customers
...
//                    binDB.Category1 = new Category();
        ...
        public void SaveShowPass(int  Save)
        {
            ...
            DAL.EFStuff.BCS.Configuration   con = db.Configurations.First();
            con.ShowPass = Save;
            db.SaveChanges();
        }
        ...
        public OnTheSpot.Models.InterogatorInfo getInfoForInterogator(OnTheSpot.Models.AutoSortInfo  customerstuff)
        {
            ...
            if (info == null)
                return null;
            List<DAL.EFStuff.Stores.Contact> contacts = (from contact in dbStore.Contacts
            ...
            foreach(DAL.EFStuff.Stores.Contact contact  in contacts)
            {
